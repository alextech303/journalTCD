...
public class WriteS500_2 {
	...
	private String note;
	public WriteS500_2(String choose, int id, String date, String name, String butch_number, String nominal_diameter,
	...
	@Override
	public int hashCode() {
		return Objects.hash(butch_number, carbon_equivalent, choose, date, edge_pitch, height_of_transverse_ribs, id,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WriteS500_2 other = (WriteS500_2) obj;
		return Objects.equals(butch_number, other.butch_number)
				&& Objects.equals(carbon_equivalent, other.carbon_equivalent) && Objects.equals(choose, other.choose)
				&& Objects.equals(date, other.date) && Objects.equals(edge_pitch, other.edge_pitch)
	...
	public String toString() {
		return "WriteS500_2 [choose=" + choose + ", id=" + id + ", date=" + date + ", name=" + name + ", butch_number="
				+ butch_number + ", nominal_diameter=" + nominal_diameter + ", nominal_square=" + nominal_square
				+ ", linear_mass=" + linear_mass + ", ovality=" + ovality + ", carbon_equivalent=" + carbon_equivalent
